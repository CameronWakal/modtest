...
export default class GraphCanvasComponent extends Component {
  get width() {
    return (this.args.xMax - this.args.xMin) * this.args.xScale;
  }

  get height() {
    return (this.args.yMax - this.args.yMin) * this.args.yScale;
  }
  ...
  draw(element) {
    ...
    let minX = this.args.xMin * 1000;
    let maxX = this.args.xMax * 1000;
    let minY = this.args.yMin * 1000;
    let maxY = this.args.yMax * 1000;
    ...
    let values = this.args.lineValues;
    ...
    values = this.args.trianglesValues;
